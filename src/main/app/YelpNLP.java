...
public class YelpNLP 
{
	 ...
	 * validated dataset, this method will utilize the NLPHelper 
	 * to classify customer reviews based on their sentiment 
	 * towards a topic. The data will then be aggregated and 
	 * averaged across all reviews for a particular restaurant 
	 * to produce valuable feedback.
	 * 
	 * @throws IOException
	 */
